...
def _knowledge_base_answer(question_lower: str, words: List[str], lang: str, user_id: int) -> Optional[str]:
...
class AIService:
    ...
    async def ask(self, question: str, user_id: int = 0, fallback_lang: str = "uk") -> str:
        ...
        kb_answer = _knowledge_base_answer(q_lower, words, lang, user_id)
        if kb_answer:
            return kb_answer
